        ...
        <main className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-10 mt-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage and generate invoices for property owners</p>
            </div>
          </div>
          ...
          {isLoading ? (
            <div className="grid gap-6">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg h-24 animate-pulse"
                />
              ))}
            </div>
          ) : invoices.length === 0 ? (
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      <th
                        className="px-6 py-4 text-left text-sm font-semibold text-gray-600 uppercase tracking-wide cursor-pointer hover:text-[#03a678]"
                        ...
                        <tr key={i._id} className="hover:bg-gray-50/70 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <select
                              ...
                              className={cn(
                                "text-sm px-4 py-2 rounded-xl border font-medium focus:outline-none focus:ring-2 focus:ring-[#03a678]/40 transition",
                                i.status === "completed"
                          ...
                          <td className="px-6 py-4">
                            <button
                              ...
                              className={cn(
                                "inline-flex items-center gap-2 px-6 py-3 bg-[#03a678] text-white font-medium rounded-xl hover:bg-[#027a55] transition shadow-md disabled:opacity-60",
