...
export default function AdminReferralsPage() {
  ...
  if (error) return <main className="min-h-screen p-8 text-destructive">{error}</main>;
  if (!data) return <main className="min-h-screen p-8 text-muted-foreground">Loading referrals…</main>;

  return <main className="mx-auto min-h-screen max-w-7xl space-y-6 px-4 pb-10 pt-20 sm:px-6 lg:px-8">
