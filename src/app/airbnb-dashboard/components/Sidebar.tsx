...
export default function Sidebar() {
  ...
  const allLinks: NavLink[] = [
    ...
    { key: "pricing", href: "/airbnb-dashboard/pricing", label: "Pricing", icon: <Sparkles size={20} />, requiredPermission: "reports:view" },
    ...
    { key: "compliance", href: "/airbnb-dashboard/compliance", label: "Compliance", icon: <ShieldCheck size={20} />, requiredPermission: "reports:view" },
